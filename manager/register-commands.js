...
const commands = [
  new SlashCommandBuilder().setName('spawn').setDescription('Spawn a new bot')
  ...
  new SlashCommandBuilder().setName('restart').setDescription('Restart a bot')
  ...
  new SlashCommandBuilder().setName('admin').setDescription('Disable/Enable a user from manager')
